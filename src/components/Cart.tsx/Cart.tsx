...
const Cart = () => {
    const { syncWithUser, setLoaded, isOpen, close, getTotalItems, items, updateQuantity, removeItem, getTotalPrice } =
        useCartStore(
            useShallow((state) => ({
    ...
    return (
        <>
            ...
            {/* Backdrop */}
            {isOpen && (
                <div className="fixed inset-0 bg-black/50  z-50 transition-opacity backdrop-blur-sm" onClick={close} />
            )}
            <div
                className={`
                    ...
                    <div className="flex-1 overflow-y-auto">
                        {items.length === 0 ? (
                            ...
                            <div className="divide-y">
                                {items.map((item) => (
                                    <div key={`cart-item-${item.id}`} className="flex gap-4 p-4 hover::bg-grat-50">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <div className="flex items-center gap-3 mt-2 ">
                                                <select
                                                    ...
                                                    className="w-16 h-8 rounded-md border border-gray-300 text-sm"
                                                >
                        ...
                        <div className="border-t">
                            ...
                            <div className="p-4 space-y-4">
                                ...
                                <div className="border-t pt-4">
                                    ...
                                    <button className="w-full cursor-pointer bg-black text-white py-4 rounded-full font-bold hover:bg-gray-900 transition-colors flex items-center justify-center">
                                        Proceed to Checkout
                                    </button>
